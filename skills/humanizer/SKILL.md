---
name: humanizer
description: Remove signs of AI-generated writing from text. Use when editing, rewriting, reviewing, or polishing prose to make it sound more natural and human-written, including when users ask to humanize text, remove AI tone, match a writing sample, reduce chatbot artifacts, cut AI vocabulary, remove em dashes, simplify promotional language, fix vague attributions, or rewrite text that feels sterile, generic, formulaic, or obviously AI-generated.
---
...
Adapted from https://github.com/blader/humanizer at commit `9600f2b7241cb4eed6ad803abee5ea01d67fe8e4`.
